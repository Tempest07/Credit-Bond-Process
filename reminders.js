import { normalizeProjectRecord, trancheNeedsPayment } from "./lifecycle.js?v=20260904-result-popover-layer";
import { protocolTransferTodos } from "./protocol-transfer.js?v=20260904-result-popover-layer";
