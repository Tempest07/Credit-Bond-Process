import { normalizeProjectRecord, trancheNeedsPayment } from "./lifecycle.js?v=20260809-protocol-selection-stable";
import { protocolTransferTodos } from "./protocol-transfer.js?v=20260809-protocol-selection-stable";
