import { normalizeProjectRecord, trancheNeedsPayment } from "./lifecycle.js?v=20260716-current-issue-group";
import { protocolTransferTodos } from "./protocol-transfer.js?v=20260716-current-issue-group";
