import { normalizeProjectRecord, trancheNeedsPayment } from "./lifecycle.js?v=20260826-mobile-date-scroll-guard";
import { protocolTransferTodos } from "./protocol-transfer.js?v=20260826-mobile-date-scroll-guard";
