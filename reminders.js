import { normalizeProjectRecord, trancheNeedsPayment } from "./lifecycle.js?v=20260904-result-ready-check";
import { protocolTransferTodos } from "./protocol-transfer.js?v=20260904-result-ready-check";
