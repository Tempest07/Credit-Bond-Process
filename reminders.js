import { normalizeProjectRecord, trancheNeedsPayment } from "./lifecycle.js?v=20260710-unified-command-system";
import { protocolTransferTodos } from "./protocol-transfer.js?v=20260710-unified-command-system";
