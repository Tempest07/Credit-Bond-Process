import { normalizeProjectRecord, trancheNeedsPayment } from "./lifecycle.js?v=20260716-result-evidence-status";
import { protocolTransferTodos } from "./protocol-transfer.js?v=20260716-result-evidence-status";
