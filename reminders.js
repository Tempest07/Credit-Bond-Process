import { normalizeProjectRecord, trancheNeedsPayment } from "./lifecycle.js?v=20260823-result-slash-header";
import { protocolTransferTodos } from "./protocol-transfer.js?v=20260823-result-slash-header";
