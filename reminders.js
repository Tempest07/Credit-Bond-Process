import { normalizeProjectRecord, trancheNeedsPayment } from "./lifecycle.js?v=20260830-state-history";
import { protocolTransferTodos } from "./protocol-transfer.js?v=20260830-state-history";
