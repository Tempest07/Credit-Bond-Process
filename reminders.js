import { normalizeProjectRecord, trancheNeedsPayment } from "./lifecycle.js?v=20260713-project-empty-state";
import { protocolTransferTodos } from "./protocol-transfer.js?v=20260713-project-empty-state";
