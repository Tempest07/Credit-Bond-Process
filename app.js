import { updateModelValuationAssist, resetModelValuationAssist } from './valuation-assistant.js?v=20260910-release-512';
import {
  ABS_CREDIT_CODE,
  ...
  upsertIssuer,
} from "./core.js?v=20260910-release-512";
import {
  FTP_TENORS,
  ...
  updateProjectCutoff,
  upsertProject,
} from "./lifecycle.js?v=20260910-release-512";
import { ISSUANCE_FIELDS, ISSUANCE_OUTCOMES, validateRecognitionRequest } from "./issuance-recognition.js?v=20260910-release-512";
import { createSequentialIssuanceQueue, ISSUANCE_QUEUE_STATUS } from "./issuance-queue.js?v=20260910-release-512";
import {
  deriveIssuerAlias,
  extractIssuerLegalName,
  parseCreditText,
  parseHistoryText,
} from "./history-parser.js?v=20260910-release-512";
import {
...
} from "./protocol-transfer.js?v=20260910-release-512";
import {
  BUILTIN_PROTOCOL_TRANSFER_TEMPLATES,
  matchProtocolTransferTemplate,
  protocolTransferTemplateById,
} from "./protocol-transfer-templates.js?v=20260910-release-512";
import {
...
} from "./protocol-transfer-docx.js?v=20260910-release-512";
import {
  buildUnifiedReminders,
  markDailyMailSent,
  normalizeReminderState,
} from "./reminders.js?v=20260910-release-512";
import {
...
} from "./secondary-inventory.js?v=20260910-release-512";
import {
  TRADE_RECORD_COLUMNS,
  TRADE_RECORD_FORMULA_COLUMNS,
} from "./trade-record-converter.js?v=20260910-release-512";
import {
...
} from "./trade-record-grid.js?v=20260910-release-512";
import {
  applyTradeRecordRowsToState,
  buildTradeRecordRows,
  buildTradeRecordTableText,
} from "./trade-record-ledger.js?v=20260910-release-512";
import { initializeDatePickers } from "./date-picker.js?v=20260910-release-512";
import { initializeRealtimeQuotes } from "./realtime-quotes.js?v=20260910-release-512";
import {
...
} from "./project-screenshot-ocr.js?v=20260910-release-512";
import {
  buildProjectScreenshotAnalysisTiles,
  detectProjectScreenshotKeyColumns,
  projectScreenshotLineCoverageMatches,
} from "./project-screenshot-layout.js?v=20260910-release-512";
import {
  inspectProjectScreenshotImageHeader,
  projectScreenshotCompositeBackground,
  projectScreenshotResizeDimensions,
  projectScreenshotResizeRetainsReadableWidth,
} from "./project-screenshot-image.js?v=20260910-release-512";
import {
  buildPaymentReceiptOriginalFileTree,
  normalizePaymentReceiptPageGroups,
} from "./payment-receipts.js?v=20260910-release-512";
import {
  buildIssuerSearchIndex,
  searchIssuerIndex,
} from "./issuer-search.js?v=20260910-release-512";
import {
  formatStateChangeSummary,
  statePayloadEquals,
} from "./state-history.js?v=20260910-release-512";
...
function scheduleDmValuationAssist(projectValue, issuer) {
  if (isAbsProject(projectValue)) resetModelValuationAssist();
  else updateModelValuationAssist(projectValue, issuer);
...
function setCloudGate(locked, options = {}) {
  ...
  delete gate.dataset.initializing;
  ...
  if (config.title) $("#cloudGateTitle").dataset.statusTitle = config.title;
  ...
  document.dispatchEvent(new CustomEvent("bond-cloud-gate-change", { detail: { locked: Boolean(locked), state: stateName } }));
}

function updateCloudGateCopy() {
  const connecting = isUiBeta() && $("#cloudGate").classList.contains("cloud-gate-connecting");
  const success = isUiBeta() && $("#cloudGate").classList.contains("cloud-gate-success");
  const title = $("#cloudGateTitle");
  title.textContent = connecting ? "Connecting Database" : success ? "Connected" : title.dataset.statusTitle || "欢迎回来";
  $("#cloudGateDetail").hidden = connecting || success;
}
