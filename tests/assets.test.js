...
const VERSION = "20260908-release-503";
...
test("exposes a readable product version consistent with package metadata", async () => {
  ...
  assert.match(html, /<meta name="application-build-version" content="5\.0\.3">/);
  assert.match(html, /class="brand-version" title="内部构建 5\.0\.3 · 2026-09-08 更新"/);
