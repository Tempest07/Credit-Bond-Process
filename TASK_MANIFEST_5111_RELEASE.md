...
- Verification: failing regression reproduced before the fix, then 113 targeted tests passed covering parsing, secondary routing, manual overrides, three real built-in DOCX ZIP templates, ledgers, converter compatibility and version/cache assets. JavaScript syntax and git diff checks passed.
